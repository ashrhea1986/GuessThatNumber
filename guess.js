//  GUESS THAT NUMBER 
// Message to be used throughout file/project
...
// For storing the number of attempts that user has left
let attempts;
...
while (restartGame){
   ...
   // Using parseInt to attempt to convert user's response to a number value (NOTE: The value returned from a prompt is a string value. Also, if the value cannot be converted then the value returned will be NaN (Not A Number))
   ...
   // Verifies the user's entry for number of attempts allowed is a number greater than zero
   ...
   // Continues looping until user guesses the correct number or runs out of attempts (NOTE: Loops until a BREAK keyword is run)
    while (true){
